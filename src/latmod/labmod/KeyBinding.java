...
public final class KeyBinding
{
	...
	{ if(!GameOptions.doublePressable.contains(this)) GameOptions.doublePressable.add(this); }
	
	public boolean isRegistredDouble()
	{ return GameOptions.doublePressable.contains(this); }
}